...
grid_nlvl = 1  # number of levels of the occupancy grid
...
radiance_field = NGPradianceField(aabb=aabb_bkgd, unbounded=args.unbounded).to(
    device
)
...
for step in range(max_steps + 1):
    ...
    rgb, acc, depth, n_rendering_samples = render_image(
        ...
        occupancy_grid,
        rays,
        scene_aabb=aabb_bkgd if not args.unbounded else None,
        # rendering options
